...
class Settings(BaseSettings):
    ...
    closed_high_mean_luma_threshold: float = Field(default=160.0, ge=0)
    closed_high_std_luma_threshold: float = Field(default=52.0, ge=0)
    open_std_luma_threshold: float = Field(default=60.0, ge=0)
    open_mid_std_luma_threshold: float = Field(default=56.7, ge=0)
    open_mid_mean_luma_max: float = Field(default=142.0, ge=0)
    ...
    closed_mid_mean_luma_max: float = Field(default=145.0, ge=0)
    closed_mid_std_luma_max: float = Field(default=56.3, ge=0)
    partial_mean_luma_threshold: float = Field(default=140.0, ge=0)
    partial_std_luma_threshold: float = Field(default=55.5, ge=0)
